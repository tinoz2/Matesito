...
const CLIENT_SECRET = process.env.MP_KEY;
...
const cuentaMercadoPago = async (req, res) => {
    try {
        ...
        if (!code) {
            const authURL = `https://auth.mercadopago.com.ar/authorization?client_id=${CLIENT_ID}&response_type=code&redirect_uri=${REDIRECT_URI}`;
